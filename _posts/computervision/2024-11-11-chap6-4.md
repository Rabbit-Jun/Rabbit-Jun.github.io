...
class TrafficWeak(QMainWindow):
    def __init__(self):
        ...
        roadButton.setGeometry(10,10,100,30)
        recognitionButton.setGeometry(10,10,100,30)
        quitButton.setGeometry(10,10,100,30)
    ...
    def recognitionFunction(self):
        if self.roadImg is None:
            ...
            if len(GM[best])<4:
                ...
                points1=np.float32([sign_kp[gm.quertIdx].pt for gm in good_match])
                ...
                cv.drawMatches(self.signImgs[best],sign_kp,self.roadImg,road_kp,good_match,img_match,flags=cv.DrawMatchersFlags_NOT_DRAW_SINGLE_POINTS)
...
```
왜 실행이 안되는지는 모르겠지만 해야할게 있어서 내일의 나에게 맡기기로 결정...
